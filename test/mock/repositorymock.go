...
// Source: internal/todo/repository/repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/todo/repository/repository.go -destination=test/mock/repositorymock.go -package=mock
//
...
func (m *MockTodoRepository) List() []domain.Todo {
	m.ctrl.T.Helper()
...
func (mr *MockTodoRepositoryMockRecorder) List() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockTodoRepository)(nil).List))
}
